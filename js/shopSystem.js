...
const SHOP_ITEMS = {
    ...
    weapons: {
        ...
        skirmisher: {
            ...
            rarity: 'common',
            stats: { pAtk: 7 },
            description: '스커미셔용 평범한 검입니다. 가볍고 빠릅니다.',
            icon: '🗡️',
            price: 50,
            sellPrice: 25,
            job: 'skirmisher'
    ...
    armors: {
        ...
        leather: {
            ...
            skirmisher: {
                ...
                rarity: 'common',
                stats: { pDef: 4, mDef: 3 },
                description: '질긴 가죽으로 만든 스커미셔용 경갑입니다. 움직임이 자유롭습니다.',
                icon: '🥋',
                price: 80,
                sellPrice: 40,
                job: 'skirmisher'
        ...
        copper: {
            ...
            skirmisher: {
                ...
                rarity: 'uncommon',
                stats: { pDef: 7, mDef: 4 },
                description: '구리 조각으로 보강된 스커미셔용 경갑입니다. 민첩성을 유지하면서 방어력을 높였습니다.',
                icon: '🥋',
                price: 120,
                sellPrice: 60,
                job: 'skirmisher'
        ...
        iron: {
            ...
            skirmisher: {
                ...
                description: '경량화된 철판으로 만든 스커미셔용 경갑입니다.',
                icon: '🥋',
                price: 180,
                sellPrice: 90,
                job: 'skirmisher'
