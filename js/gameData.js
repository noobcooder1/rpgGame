...
const MAPS = {
    training: {
        ...
        exploreItems: [
            ...
            { id: 'rusty_longsword', name: '녹슨 대검', chance: 0.02 },
            { id: 'rusty_sword', name: '녹슨 단검', chance: 0.03 },
...
function getRequiredExp(level) {
    if (level <= 20) {
        // 초반 (1 ~ 20레벨)
        return Math.floor(30 * Math.pow(level, 1.8));
    } else if (level <= 99) {
        // 중반 (21 ~ 99레벨)
...
const MONSTERS = {
    ...
    spar_trainee1: {
        ...
        drops: [],
        emoji: '👦',
        image: 'assets/monsters/trainee1.png',
        isSpar: true,
        sparClass: 'trainee',
    ...
    spar_trainee2: {
        ...
        drops: [],
        emoji: '👧',
        image: 'assets/monsters/trainee2.png',
        isSpar: true,
        sparClass: 'trainee',
    ...
    spar_trainee3: {
        ...
        drops: [],
        emoji: '🧒',
        image: 'assets/monsters/trainee3.png',
        isSpar: true,
        sparClass: 'trainee',
    ...
    spar_trainee4: {
        ...
        drops: [],
        emoji: '👱',
        image: 'assets/monsters/trainee4.png',
        isSpar: true,
        sparClass: 'trainee',
...
const NPCS = {
    ...
    instructor2: {
        ...
        dialogues: {
            ...
            quest_complete: '수고했네. 꽤나 힘들었을 텐데 잘 완수해주었군! 여기 약속한 보상일세.',
    ...
    instructor3: {
        ...
        dialogues: {
            ...
            quest_complete: '좋은 결과군. 어려운 수련이었을 텐데 끝까지 해낸 점이 마음에 드네. 약속한 보상일세.',
    ...
    instructor4: {
        ...
        dialogues: {
            ...
            quest_complete: '완수했군. 생각보다 훨씬 깔끔한 움직임이었어. 약속한 보상을 챙겨가게.',
    ...
    senior_instructor: {
        ...
        dialogues: {
            ...
            quest_complete: '훌륭하군. 쉽지 않은 임무였을 텐데 끝내 완수했어. 약속한 보상을 받게.',
            spar: '한 수 가르쳐주지. 준비됐나?',
